...
import javax.swing.*;
	public class board extends JPanel implements ActionListener, KeyListener  {
      ...
      public board(int n, int [][] csv, ImageIcon[] images, JLabel steps, Timer time, JButton undo, JLabel timer,HashMap<Integer, LinkedList<int[][]>> csvLists, HashMap<String, ImageIcon[][]> filesMap)
      {
